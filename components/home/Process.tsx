  ...
  return (
    <div className='relative w-full h-full bg-cover bg-fixed' style={{
        ...
        <div className='w-[80%] flex flex-col items-center sm:items-center justify-center relative z-10 text-white m-[30px]'>
            ...
            <p className='mt-[20px] w-[70%] text-center text'>We believe in a seamless approach to delivering results that exceed expectations. Our process is designed to be meticulous, efficient, and focused on your business goals, ensuring that every project we undertake is executed flawlessly from start to finish.
            </p>
