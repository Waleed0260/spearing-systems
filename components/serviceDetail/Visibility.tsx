...
const Visibility = ({ heading, text, CTA, id }: any) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center ">
      <div className="w-[80vw] flex flex-col items-start justify-center mt-[200px]">
        ...
        <div className="flex flex-row justify-between items-start gap-3 mt-[50px]">
          <div className="flex flex-col w-[65%] gap-3">
            ...
            <Button
              variant={"outline"}
              className="mt-[20px] w-[400px] bg-blue-700 rounded-[100px] text-white"
            >
              {CTA}
            </Button>
            ...
            <div className="flex flex-col items-center justify-center p-6 mt-5">
              ...
              >
                <input
                  ...
                  name=""
                  id=""
                  className="w-[380px] h-[40px] mt-6 rounded-md p-5 border-[2px] border-black"
                  placeholder="Name*"
                />
                <input
                  type="text"
